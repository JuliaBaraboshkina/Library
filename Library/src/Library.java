...
public class Library implements Action {
    ...
    public synchronized void enter(Reader reader) {
        ...
        System.out.println("Посетитель " + reader.getName() + " вошел(а) в библиотеку");
        System.out.println("Посетителей в библиотеке: " + readersInRoom);
    ...
    public synchronized void exit(Reader reader) {
        ...
        System.out.println("Посетитель " + reader.getName() + " вышел(а) из библиотеки");
        System.out.println("Посетителей в библиотеки: " + readersInRoom);
        notify(); // Уведомление других потоков об освобождении места в библиотеке
    }
    ...
    synchronized void giveBook(Reader reader, Book book) {
        ...
        System.out.println("Посетитель " + reader.getName() + " взял(а) книгу " + book.getId());
    }
    ...
    synchronized void returnBook(Reader reader, Book book) {
        ...
        System.out.println("Посетитель " + reader.getName() + " вернул(а) книгу " + book.getId());
    }
