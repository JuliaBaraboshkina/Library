...
public class Reader implements Runnable {
        ...
        try {
            while (true) {
                ...
                switch (action) {
                    ...
                    case 4:
                        setLocation("дом");
                        System.out.println("Посетитель " + this.name + " дома");
                        Thread.sleep(5000);
                        break;
                    case 5:
                    ...
                    case 6:
                        if (Reader.this.books.size() > 0) {
                            System.out.println("Посетитель " + this.name + " читает");
                            Thread.sleep(10000);
                        } else break;
                        break;
                    case 7:
                    ...
                    case 8:
                        ...
                        System.out.println("Посетитель " + Reader.this.name + " вошел(а) в здание");
                        break;
                }
            }
    ...
    private void readAtReadingRoom(Book book) {
        try {
            setLocation("читательный зал");
            System.out.println("Посетитель " + this.name + " читает книгу " + book.getId() + ", которую можно читать только в зале");
            Thread.sleep(10000);
