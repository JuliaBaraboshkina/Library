public class Room implements Action {
    ...
    public synchronized void enter(Reader reader) {
        ...
        System.out.println("Посетитель " + reader.getName() + " вошел(а) в читательный зал");
        System.out.println("Посетителей в читательном зале: " + readers);
    ...
    public synchronized void exit(Reader reader) {
        ...
        System.out.println("Посетитель " + reader.getName() + " покинул(а) читательный зал");
        System.out.println("Посетителей в читательном зале: " + readers);
